...
class EncoderGRU(nn.Module):
    def __init__(self, input_size, embedding_size, hidden_size, num_layers=1, dropout=0.1):
        ...
        self.gru = nn.GRU(
            ...
            bidirectional=True  # Changed to bidirectional for better context
        )
...
def create_translation_model(english_vocab_size, french_vocab_size, 
    ...
    """
    # Create encoder (now bidirectional)
    encoder = EncoderGRU(
        input_size=english_vocab_size,
